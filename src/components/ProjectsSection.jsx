...
const projects = [
  ...
  {
    name: 'DigitalRichAI Landing Page',
    emoji: '🧠',
    description: 'Faceless brand landing page to promote content and digital product. Includes hero section and newsletter signup.',
